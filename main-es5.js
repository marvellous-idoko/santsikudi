  ...
  function srcAppDepositDepositComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DepositComponent = /*#__PURE__*/function () {
      function DepositComponent(r, l, s, fb, pS) {
        ...
        this.amounts = [{
          name: '200,000',
          abbreviation: '20000000'
        }, {
          name: '180,000',
          abbreviation: '10000000'
        }, {
          name: '170,000',
          abbreviation: '17000000'
        }, {
          name: '150,000',
          abbreviation: '15000000'
        }, {
          name: '130,000',
          abbreviation: '13000000'
        }, {
          name: '120,000',
          abbreviation: '12000000'
        }, {
          name: '100,000',
          abbreviation: '10000000'
        }, {
          name: '70,000',
          abbreviation: '7000000'
        }, {
          name: '50,000',
          abbreviation: '5000000'
        }, {
          name: '20,000',
          abbreviation: '2000000'
        }, {
          name: '10,000',
      ...
      _createClass(DepositComponent, [{
        ...
        value: function paymentDone() {
          this.pS.sav(this.addressForm.get('amount').value, this.ref, this.s.checkLogUser()).subscribe(function (a) {
            console.info(a);
          });
                ...
                case 0:
                  {
                    r = confirm(s['msg']);
                    _this2.hu = s;
                    _this2.show = true; // this.d.getElementsByClassName('dialog')
                    // this.d.getElementById('dialog').showModal();
                    // g.
      ...
      _createClass(LoanComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.ls.loan(this.addressForm.value).subscribe(function (s) {
            ...
            if (r == true) _this4.r.navigateByUrl('loanstatus');
  ...
  function srcAppPoissonServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PoissonService = /*#__PURE__*/function () {
      ...
      _createClass(PoissonService, [{
        key: "sav",
        value: function sav(a, b, user) {
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
          headers.append('Content-Type', 'applicatiion/json');
          return this.Http.get(this.server + 'updAcct/' + a + '/' + b + '/' + user['fullName'] + '/' + user['account_no'] + '/' + user['account_no'] + '/' + user['fullName'], {
            headers: headers
          });
        }
      }, {
    ...
    var VCComponent = /*#__PURE__*/function () {
      function VCComponent(s, l, fb, r) {
        ...
        this.addressForm = this.fb.group({
          ...
          email: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(this.ed)])],
          contact: [234, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(10), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].maxLength(11)])],
          ...
          pwd: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(6)])]
        });
        this.types = [{
          name: 'Business',
          abbreviation: 'primary'
      ...
      _createClass(VCComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.e = this.s.loans(); // if(JSON.parse(localStorage.getItem("user"))['acctType'] != 'vc')
          // {
        ...
        value: function withdraw() {
          ...
          this.s.withdraw(this.addressForm.get('amount').value).subscribe(function (e) {
            if (confirm(e.msg) == true) {
              _this7.r.navigateByUrl('account_balance');
            }
