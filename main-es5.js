                ...
                case 0:
                  {
                    ...
                    _this5.hu = s;
                    _this5.show = true;
                    _this5.ii = ""; // this.d.getElementsByClassName('dialog')
                    // this.d.getElementById('dialog').showModal();
                    // g.
      ...
      _createClass(HomeComponent, [{
        ...
        value: function chk() {
          ...
          if (z == 'e') {
            ...
            this.d.getElementById('yy').style.display = 'none'; // this.audioObj.play()
  ...
  function srcAppPoissonServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PoissonService = /*#__PURE__*/function () {
      ...
      _createClass(PoissonService, [{
        ...
        key: "retrDebit",
        value: function retrDebit(user) {
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
          headers.append('Content-Type', 'applicatiion/json');
          return this.Http.get(this.server + 'retrDebit/' + user['account_no'], {
            headers: headers
          });
        }
      }, {
        ...
        key: "genWitId",
        value: function genWitId(d) {
          console.info(d);
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
          headers.append('Content-Type', 'applicatiion/json');
          return this.Http.post(this.server + 'withID', d, {
            headers: headers
          });
        }
      }]);
