...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppLoanStatusLoanStatusComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<p>loan-status works!</p>\n";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppVcVcComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<p>vc works!</p>\n";
    /***/
  },
  ...
  function srcAppLoanLoanComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoanComponent = /*#__PURE__*/function () {
      ...
      _createClass(LoanComponent, [{
        ...
        key: "chkLog",
        value: function chkLog() {
          this.s.checkLogUser().subscribe(function (d) {
            console.info(d);
          });
        }
      }]);
      ...
      _createClass(RegLogService, [{
        ...
        value: function login(d) {
          ...
          return this.Http.post(this.server + 'login', d, {
            ...
            _this4.d.getElementById('loader').classList.remove('show');

            if (d['code'] == 1) {
              _this4.rr = confirm(d['msg']);
            ...
            _this4.rr = confirm(d['msg']); // if (this.rr == true) this.r.navigateByUrl('home');
            // this.r.navigateByUrl('home');
          });
        }
      }, {
